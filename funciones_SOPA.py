import random
def insertar_palabra_horizontal (BOX_SIZE,palabra,matriz,g,filas_validas,fuente):   #en filas validas se le debe mandar una lista con las filas que todavia no tienen una palabra insertada
...
def insertar_palabra_vertical (BOX_SIZE,palabra,matriz,g,columnas_validas,fuente):
	pos_maxima=17-len(palabra)
	pos=random.choice(range(0,pos_maxima))
